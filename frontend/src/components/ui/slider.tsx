...
const Slider = React.forwardRef(({ className, defaultValue, min, max, step, formatLabel, value, onValueChange, ...props }: SliderProps, ref) => {
    ...
    >
      ...
      {localValues.map((value, index) => (
        <React.Fragment key={index}>
          <div
            className="absolute text-center text-gray-500 space-x-2"
            style={{
