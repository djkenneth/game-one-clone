export const products = [
    ...
    {
        title: "PlayStation PS5 Slim Console with Two DualSense Controller Bundle",
        price: 33990,
        availability: true,
        image: "https://gameone.ph/media/catalog/product/cache/d378a0f20f83637cdb1392af8dc032a2/p/l/playstationps5-slim-console-5_1_1.jpg",
        description: "Key Features\nSlim DesignWith PS5®, players get powerful gaming technology packed inside a sleek and compact console design.\n1TB of StorageKeep your favorite games ready and waiting for you to jump in and play with 1TB of SSD storage built in.***\nUltra-High Speed SSDMaximize your play sessions with near instant load times for installed PS5® games.\nIntegrated I/OThe custom integration of the PS5® console's systems lets creators pull data from the SSD so quickly that they can design games in ways never before possible.\nRay TracingImmerse yourself in worlds with a new level of realism as rays of light are individually simulated, creating true-to-life shadows and reflections in supported PS5® games.\n4K-TV GamingPlay your favorite PS5® games on your stunning 4K TV.\nUp to 120fps with 120Hz outputEnjoy smooth and fluid high frame rate gameplay at up to 120fps for compatible games, with support for 120Hz output on 4K displays.\nHDR TechnologyWith an HDR TV, supported PS5® games display an unbelievably vibrant and lifelike range of colors.\nTempest 3D AudioTechImmerse yourself in soundscapes where it feels as if the sound comes from every direction. Your surroundings truly come alive with Tempest 3D AudioTech** in supported games.\nHaptic FeedbackExperience haptic feedback via the DualSense® wireless controller in select PS5® titles and feel the effects and impact of your in-game actions through dynamic sensory feedback.\nAdaptive TriggersGet to grips with immersive adaptive triggers, featuring dynamic resistance levels which simulate the physical impact of in-game activities in select PS5® games.\nIncludes ASTRO’S PlayroomExplore four worlds, each one showcasing innovative gameplay using the versatile features of the DualSense® wireless controller, in this game included for all PS5® console users.\nBackwards Compatibility & Game BoostThe PS5® console can play over 4,000 PS4® games. With the Game Boost feature, you can even enjoy faster and smoother frame rates in some of the PS4® console’s greatest games.\nApple MusicGet up to six months of Apple Music at no extra cost with your PS5® console and play millions of songs and thousands of playlists, ad-free",
        sku: "4948872615815",
        url: "https://gameone.ph/playstation-ps5-slim-console-with-two-dualsense-controller-bundle.html",
        categories: [
            "PlayStation",
            "Console"
        ]
    ...
    {
        title: "PlayStation PS5 Slim Console Disc Version",
        price: 30790,
        availability: true,
        image: "https://gameone.ph/media/catalog/product/cache/d378a0f20f83637cdb1392af8dc032a2/p/l/playstationps5-slim-console-6_2.jpg",
        description: "Key Features\nSlim DesignWith PS5®, players get powerful gaming technology packed inside a sleek and compact console design.\n1TB of StorageKeep your favorite games ready and waiting for you to jump in and play with 1TB of SSD storage built in.***\nUltra-High Speed SSDMaximize your play sessions with near instant load times for installed PS5® games.\nIntegrated I/OThe custom integration of the PS5® console's systems lets creators pull data from the SSD so quickly that they can design games in ways never before possible.\nRay TracingImmerse yourself in worlds with a new level of realism as rays of light are individually simulated, creating true-to-life shadows and reflections in supported PS5® games.\n4K-TV GamingPlay your favorite PS5® games on your stunning 4K TV.\nUp to 120fps with 120Hz outputEnjoy smooth and fluid high frame rate gameplay at up to 120fps for compatible games, with support for 120Hz output on 4K displays.\nHDR TechnologyWith an HDR TV, supported PS5® games display an unbelievably vibrant and lifelike range of colors.\nTempest 3D AudioTechImmerse yourself in soundscapes where it feels as if the sound comes from every direction. Your surroundings truly come alive with Tempest 3D AudioTech** in supported games.\nHaptic FeedbackExperience haptic feedback via the DualSense® wireless controller in select PS5® titles and feel the effects and impact of your in-game actions through dynamic sensory feedback.\nAdaptive TriggersGet to grips with immersive adaptive triggers, featuring dynamic resistance levels which simulate the physical impact of in-game activities in select PS5® games.\nIncludes ASTRO’S PlayroomExplore four worlds, each one showcasing innovative gameplay using the versatile features of the DualSense® wireless controller, in this game included for all PS5® console users.\nBackwards Compatibility & Game BoostThe PS5® console can play over 4,000 PS4® games. With the Game Boost feature, you can even enjoy faster and smoother frame rates in some of the PS4® console’s greatest games.\nApple MusicGet up to six months of Apple Music at no extra cost with your PS5® console and play millions of songs and thousands of playlists, ad-free",
        sku: "4948872415927",
        url: "https://gameone.ph/playstation-ps5-slim-console-disc-version.html",
        categories: [
            "PlayStation",
            "Console"
        ]
    ...
    {
        title: "PlayStation PS4 NBA 2K25 Standard Edition [R3]",
        price: 4190,
        availability: true,
        image: "https://gameone.ph/media/catalog/product/cache/d378a0f20f83637cdb1392af8dc032a2/p/s/ps4-nba-2k25_1.jpg",
        description: "Stack wins, raise banners, and make history in NBA 2K25. Command every court with authenticity and realism Powered by ProPLAY, giving you ultimate control over how you compete. Play anywhere, as you define your legacy in MyCAREER, MyTEAM, MyNBA, and The W. Express your personality with an extensive array of customization options and explore an all-new City, where opportunity awaits behind every door.\nPOWERED BY ProPLAYBring your game to life with ProPLAY, immersive technology that directly translates NBA footage into engaging gameplay. Get up close and personal with your favorite NBA superstars and immerse yourself in clutch moments, as ProPLAY powers the most authentic NBA experience to date.\nCOMPETE IN THE CITYThe City is the ultimate proving ground; hit the park for some competitive streetball fun and compete at various new venues. Pay homage to legends of the game in MyCAREER as you eclipse their milestone achievements and usher in the greatest dynasty basketball has ever seen. Let your talents shine in a bustling City and etch your name among the greats.\nBUILD YOUR DYNASTYBuild a dynasty that transcends eras and redefine what it means to be the best as a General Manager in MyNBA. Explore the unique challenges that come with overseeing an NBA front office and cherish the ultimate reward of winning a championship, or multiple. Choose from six Eras, including an all-new Era, and become the next mastermind to change the game forever.",
        sku: "5026555434362",
        url: "https://gameone.ph/playstation-ps4-nba-2k25-standard-edition-r3.html",
        categories: [
            "PlayStation",
            "PS4 Games"
        ]
    ...
    {
        title: "PlayStation PS4 Visions of Mana [R3]",
        price: 3095,
        availability: false,
        image: "https://gameone.ph/media/catalog/product/cache/d378a0f20f83637cdb1392af8dc032a2/p/s/ps4_visions_of_mana_r3_1.jpg",
        description: "Visions of Mana is a brand new title in this series revolving around the sacred sword and mana.\nThe protagonist Val and his childhood friend Hinna, the newly appointed Alm of Fire, set off on a journey to the Mana Tree.\nThis game’s iconic vibrant and vast semi-open field contains adorable yet ferocious monsters, allowing you to enjoy swift three-dimensional battles using the power of the Elementals.\nThrough adventures with friends met along the way, they start to see the truth about the world.\nMust we accept our fates?\nA new “Mana” tale begins here as a classic fantasy series returns to its roots.\nIn Tianeea, the Fire Village, everyone is preparing to celebrate the coming of the Faerie and the naming of an “alm.” Every four years, alms from around the world are chosen to travel to the Tree of Mana and rejuvenate the flow of mana power. A soul guard is also chosen to ensure the alms' safe pilgrimage. Val is one such guard.\nFeatures:\n\nBold graphics full of characteristic “Mana” flair - The characters journey across a vibrant world alive with spiritsExploring the world - Explore the vast, semi-open field that stretches as far as the eye can see. Traverse the environment quickly and safely with new companions, the “Pikuls”\nHarness the power of the Elementals - In this game, you will fight enemies using weapons that house the power of the Elementals. Change between different classes and characters to suit your playstyle and enjoy combat that has evolved both three-dimensionally and strategically\nBreathtaking and immersive soundtrack - A total of 100 background music tracks by a talented team of creators who have worked on countless tracks throughout the series. The music in field areas feature interactive music, heightening the mood for adventure",
        sku: "8885011018259",
        url: "https://gameone.ph/playstation-ps4-visions-of-mana-r3.html",
        categories: [
            "PlayStation",
            "PS4 Games"
        ]
    ...
    {
        title: "PlayStation PS4 Bayonetta & Vanquish 10th Anniversary Bundle Launch Edition [R2]",
        price: 1395,
        availability: false,
        image: "https://gameone.ph/media/catalog/product/cache/d378a0f20f83637cdb1392af8dc032a2/p/s/ps4_g._bayonetta_and_vanquish_10th_anniv_launch_steelcase_r2.jpg",
        description: "Celebrate the 10th Anniversary of two PlatinumGames cult classics with the Bayonetta & Vanquish 10th Anniversary Bundle!\nBayonetta and Vanquish will be coming to PlayStation 4 and Xbox One for the first time in this remastered dual-pack.\nBayonetta: Experience the genesis of the Bayonetta series with the cult classic, original action-adventure game.\nVanquish: The hit sci-fi shooter returns. An overpopulated Earth suffocating under limited resources looks to Providence, the solar-powered space colony for support.\nSPECIAL LAUNCH EDITION: Commemorate the 10th anniversary of Bayonetta and Vanquish with a special launch edition Steelbook, featuring custom 10th anniversary art.",
        sku: "5055277036349",
        url: "https://gameone.ph/playstation-ps4-bayonetta-vanquish-10th-anniversary-bundle-launch-edition-r2.html",
        categories: [
            "PlayStation",
            "PS4 Games"
        ]
    ...
    {
        title: "PlayStation PS4 The Last of Us Remastered - PlayStation Hits",
        price: 1095,
        availability: true,
        image: "https://gameone.ph/media/catalog/product/cache/d378a0f20f83637cdb1392af8dc032a2/t/h/the-last-of-us-remastered---playstation-hits---playstation-4-2_1_.jpg",
        description: "Now featuring full 1080p, higher resolution character models, improved shadows and lighting, in addition to several other gameplay improvements. 20 years after a pandemic has radically changed known civilization, infected humans run wild and survivors are killing each other for food, weapons; whatever they can get their hands on. Joel, a violent survivor, is hired to smuggle a 14 year-old girl, Ellie, out of an oppressive military quarantine zone, but what starts as a small job soon transforms into a brutal journey across the U.S.\nThe Last of Us Remastered includes the Abandoned Territories Map Pack, Reclaimed Territories Map Pack, and the critically acclaimed The Last of Us: Left Behind Single Player campaign that combines themes of survival, loyalty, and love with tense, survival-action gameplay.",
        sku: "812345678901126",
        url: "https://gameone.ph/playstation-ps4-the-last-of-us-remastered-playstation-hits.html",
        categories: [
            "PlayStation",
            "PS4 Games"
        ]
    ...
    {
        title: "PlayStation PS5 EA Sports College Football 25 [R1]",
        slug: "playstation-ps5-ea-sports-college-football-25-[r1]",
        price: 3995,
        availability: true,
        image: "https://gameone.ph/media/catalog/product/cache/d378a0f20f83637cdb1392af8dc032a2/p/s/ps5_g._college_football_25_r1_.jpg",
        description: "In EA SPORTS College Football 25, experience explosive gameplay variety across 134 FBS schools and immerse yourself in the iconic atmospheres of college football as you chase college greatness.",
        sku: "014633382037",
        url: "https://gameone.ph/playstation-ps5-ea-sports-college-football-25-r1.html",
        categories: [
            "PlayStation",
            "PS5 Games"
        ]
    ...
    {
        title: "PlayStation PS5 NBA 2K25 All-Star Edition [R3]",
        slug: "playstation-ps5-nba-2k25-all-star-edition-[r3]",
        price: 5990,
        availability: false,
        image: "https://gameone.ph/media/catalog/product/cache/d378a0f20f83637cdb1392af8dc032a2/p/s/ps5-nba-2k25-all-star-edition_1.jpg",
        description: "Stack wins, raise banners, and make history in NBA 2K25. Command every court with authenticity and realism Powered by ProPLAY, giving you ultimate control over how you compete. Play anywhere, as you define your legacy in MyCAREER, MyTEAM, MyNBA, and The W. Express your personality with an extensive array of customization options and explore an all-new City, where opportunity awaits behind every door.\nPOWERED BY ProPLAYBring your game to life with ProPLAY, immersive technology that directly translates NBA footage into engaging gameplay. Get up close and personal with your favorite NBA superstars and immerse yourself in clutch moments, as ProPLAY powers the most authentic NBA experience to date.\nCOMPETE IN THE CITYThe City is the ultimate proving ground; hit the park for some competitive streetball fun and compete at various new venues. Pay homage to legends of the game in MyCAREER as you eclipse their milestone achievements and usher in the greatest dynasty basketball has ever seen. Let your talents shine in a bustling City and etch your name among the greats.\nBUILD YOUR DYNASTYBuild a dynasty that transcends eras and redefine what it means to be the best as a General Manager in MyNBA. Explore the unique challenges that come with overseeing an NBA front office and cherish the ultimate reward of winning a championship, or multiple. Choose from six Eras, including an all-new Era, and become the next mastermind to change the game forever.",
        sku: "5026555434409",
        url: "https://gameone.ph/playstation-ps5-nba-2k25-all-star-edition-r3.html",
        categories: [
            "PlayStation",
            "PS5 Games"
        ]
    ...
    {
        title: "PlayStation PS5 NBA 2K25 Standard Edition [R3]",
        slug: "playstation-ps5-nba-2k25-standard-edition-[r3]",
        price: 4190,
        availability: false,
        image: "https://gameone.ph/media/catalog/product/cache/d378a0f20f83637cdb1392af8dc032a2/p/s/ps5-nba-2k25_1.jpg",
        description: "Stack wins, raise banners, and make history in NBA 2K25. Command every court with authenticity and realism Powered by ProPLAY, giving you ultimate control over how you compete. Play anywhere, as you define your legacy in MyCAREER, MyTEAM, MyNBA, and The W. Express your personality with an extensive array of customization options and explore an all-new City, where opportunity awaits behind every door.\nPOWERED BY ProPLAYBring your game to life with ProPLAY, immersive technology that directly translates NBA footage into engaging gameplay. Get up close and personal with your favorite NBA superstars and immerse yourself in clutch moments, as ProPLAY powers the most authentic NBA experience to date.\nCOMPETE IN THE CITYThe City is the ultimate proving ground; hit the park for some competitive streetball fun and compete at various new venues. Pay homage to legends of the game in MyCAREER as you eclipse their milestone achievements and usher in the greatest dynasty basketball has ever seen. Let your talents shine in a bustling City and etch your name among the greats.\nBUILD YOUR DYNASTYBuild a dynasty that transcends eras and redefine what it means to be the best as a General Manager in MyNBA. Explore the unique challenges that come with overseeing an NBA front office and cherish the ultimate reward of winning a championship, or multiple. Choose from six Eras, including an all-new Era, and become the next mastermind to change the game forever.",
        sku: "5026555434386",
        url: "https://gameone.ph/playstation-ps5-nba-2k25-standard-edition-r3.html",
        categories: [
            "PlayStation",
            "PS5 Games"
        ]
    ...
    {
        title: "PlayStation PS5 Warhammer 40,000: Space Marine 2 Gold Edition [R3]",
        slug: "playstation-ps5-warhammer-40,000:-space-marine-2-gold-edition-[r3]",
        price: 5095,
        availability: false,
        image: "https://gameone.ph/media/catalog/product/cache/d378a0f20f83637cdb1392af8dc032a2/w/a/warhammer-40--000-space-marine-ii-gold-edition_2.jpg",
        description: "Your Craft is Death.\nEmbody the superhuman skill and brutality of a Space Marine, the greatest of the Emperor’s warriors. Hold at bay the horrors of the galaxy in epic battles on far-flung planets with your deadly abilities and devastating weaponry. Uncover dark secrets to drive back the everlasting night and prove your ultimate loyalty to humanity.\nCrush the Tyranid swarms. Defend humanity.\n● Purge the relentless Tyranid swarms as legendary Space Marine Titus in a spectacular new campaign. Play solo or with up to 2 friends in 3 player co-op.● Enjoy intense, gory and fast-paced third-person action with hundreds of enemies on screen, from the creators of blockbuster co-op shooter World War Z.● Defend the Imperium as your own Space Marine in an endlessly brutal and replayable PvE missions up to 3 players featuring 6 classes, unlocking new skills and cosmetics.● Wage eternal war on your enemies in ferocious 6v6 PvP matches and bring glory to your faction!",
        sku: "3512899967885",
        url: "https://gameone.ph/playstation-ps5-warhammer-40-000-space-marine-2-gold-edition-r3.html",
        categories: [
            "PlayStation",
            "PS5 Games"
        ]
    ...
    {
        title: "[PRE-ORDER] Awaken Astral Blade Tania's Edition [R2]",
        slug: "[pre-order]-awaken-astral-blade-tania's-edition-[r2]",
        price: 500,
        availability: true,
        image: "https://gameone.ph/media/catalog/product/cache/d378a0f20f83637cdb1392af8dc032a2/p/s/ps5-awaken-astral-blade-tanias-edition.jpg",
        description: "Weave your own story in this metroidvania set in a dark fairy tale. In the mysterious ancient ruins, you embark on an adventure with a bionic girl named Tania to uncover her origins and destiny.\nBut is there any chance of survival in this dark and desperate place?\nFeatures\n\nWeave your own story in this metroidvania set in a dark fairy tale. In the mysterious ancient ruins, you embark on an adventure with a bionic girl named Tania to uncover her origins and destiny. But is there any chance of survival in this dark and desperate place?\nAWESOME AND EXCITING COMBAT - Parry attacks to gain an advantage or use the Fast Stand Up skill and become immune to damage. Combos will also help you fight your way through\nRICH PLOT AND VARIOUS ENDINGS - Control the story, make choices at key moments and follow your own path to unravel mysteries of the past and present. Different routes may lead to different endings!\nDIVERSE AND UNIQUE COSTUMES - Collect mysterious Aether to improve Tania’s strength or spend it on new skills. Upgrade your weapons or trade some Aether for useful items, the choice is yours",
        sku: "812345678901220",
        url: "https://gameone.ph/pre-order-awaken-astral-blade-tania-s-edition-r2.html",
        categories: [
            "PlayStation",
            "PS5 Games"
        ]
    ...
    {
        title: "[PRE-ORDER] PlayStation PS5 Cocoon [R3]",
        slug: "[pre-order]-playstation-ps5-cocoon-[r3]",
        price: 500,
        availability: true,
        image: "https://gameone.ph/media/catalog/product/cache/d378a0f20f83637cdb1392af8dc032a2/p/s/ps5-cocoon.jpg",
        description: "An adventure across worlds within worlds.\nFrom Jeppe Carlsen, the lead gameplay designer of LIMBO and INSIDE — COCOON takes you on an adventure across worlds within worlds. Master world-leaping mechanics to unravel a cosmic mystery.\nFeatures\nWorlds within Worlds - COCOON is a unique take on the puzzle adventure genre, where each world exists within an orb that you can carry on your back. Wrap your head around the core mechanic of leaping between worlds—and combine, manipulate, and rearrange them to solve intricate puzzles\nAlien Machinery - Interact with alien environments and biomechanical devices left behind by an ancient civilization. Journey through unique and diverse biomes, from industrial structures to massive organic caverns, and discover how they are connected to one another\nOrb Abilities - Each orb has an ability that can be unlocked, thereby turning the orb into a unique tool for you to utilize within other worlds. Use these abilities to uncover hidden pathways and objects, fire projectiles to trigger switches, and more\nMonstrous Guardians - Mighty guardians protect every world, and you must face them in fierce battles. Each fight is unique and requires you to master new and satisfying mechanics",
        sku: "812345678901219",
        url: "https://gameone.ph/pre-order-playstation-ps5-cocoon-r3.html",
        categories: [
            "PlayStation",
            "PS5 Games"
        ]
    ...
    {
        title: "[PRE-ORDER] PlayStation PS5 SpongeBob SquarePants: The Patrick Star Game [R2]",
        slug: "[pre-order]-playstation-ps5-spongebob-squarepants:-the-patrick-star-game-[r2]",
        price: 500,
        availability: true,
        image: "https://gameone.ph/media/catalog/product/cache/d378a0f20f83637cdb1392af8dc032a2/p/s/ps5-spongebob-squarepants-the-patrick-star-game.jpg",
        description: "Step into Patrick’s shorts and create hilarious, physics-based mayhem, as you make the open world of Bikini Bottom your playground!\nPatrick fans, your time has come – and Bikini Bottom is your open-world playground!\nYou can skydive with just a parasol (or nothing at all), search for buried treasure in the Dump, or release the rage in Mrs. Puff’s Rage Room. Use almost any item you find, - from the reef blower to a paint can, - to make the world more Patrick. And take on challenges only Patrick would attempt, set by up SpongeBob, Sandy Cheeks, Mr. Krabs, and more.\nSo become the Star of the show, put your silliest ideas into action, and enjoy the physics-based chaos that unfolds all around you!\nFeatures\nTHIS IS PATRICK! - Create hilarious mayhem in the open world of Bikini Bottom\nFUN WITH PHYSICS - Take things and push them somewhere else. Physics!\nICONIC STYLES – Unlock classic Patrick outfits with your crazy stunts and collectibles\nEVERYONE'S HERE - Get silly with SpongeBob, Squidward, Sandy, and more",
        sku: "812345678901212",
        url: "https://gameone.ph/pre-order-playstation-ps5-spongebob-squarepants-the-patrick-star-game-r2.html",
        categories: [
            "PlayStation",
            "PS5 Games"
        ]
    ...
    {
        title: "PlayStation PS5 WRC Generations [R1]",
        slug: "playstation-ps5-wrc-generations-[r1]",
        price: 1350,
        availability: true,
        image: "https://gameone.ph/media/catalog/product/cache/d378a0f20f83637cdb1392af8dc032a2/p/s/ps5-g.-wrc-generations-_r1_.jpg",
        description: "7 years of hard work, a true passion for motorsport, and absolutely NO CUTS! Kylotonn and Nacon are thrilled to bring you the final installment in our beloved official WRC Franchise.\nWe’ve got all the WRC 2022 calendar action, including the new Rally1 and hybrid cars! Including a return to the world-famous Rally Sweden!\nll-new solo and online content, with career options to manage your hybrid-powered cars. A league mode, an improved Team system, and an updated version of our livery editor with sharing!\nPrepping the car, running shakedowns, and looking at the data… all show us that WRC",
        sku: "814290018245",
        url: "https://gameone.ph/playstation-ps5-wrc-generations-r1.html",
        categories: [
            "PlayStation",
            "PS5 Games"
        ]
    ...
    {
        title: "[PRE-ORDER] PlayStation PS5 Fairy Tail 2 [R3]",
        slug: "[pre-order]-playstation-ps5-fairy-tail-2-[r3]",
        price: 500,
        availability: true,
        image: "https://gameone.ph/media/catalog/product/cache/d378a0f20f83637cdb1392af8dc032a2/p/s/ps5-fairy-tail-2.jpg",
        description: "Relive the dramatic culmination of the original series through gameplay!\nThis RPG depicts the dramatic developments of the “Alvarez Empire Arc,” the climax of the original story. Playing as the main characters Natsu and Lucy and other members of the Fairy Tail Guild, players can relive the epic battles against their greatest enemy, Emperor Spriggan (Zeref) of the Alvarez Empire, his team of elites, the \"Spriggan 12\", and the world destroyer Black Dragon Acnologia.\n\nFlashy magic battles with unique characters! - The battle system has been completely redesigned from the previous game, implementing real-time battles that are even more flashy and impactful. In addition to being able to use more powerful magic by filling up the gauge when attacking, some characters can also activate \"Mode Change\". Use these and other strategic elements to your advantage and feel the thrill of exhilarating battles!\nSeamlessly explore the final battlefield of the Kingdom of Fiore! - The world of FAIRY TAIL is recreated with beautiful 3D graphics. Expressive character expressions and seamless field navigation, uninterrupted by load times, will allow you to feel immersed in the world of the original series as if you were exploring it yourself!\nAn abundance of exclusive in-game content, including an original epilogue! - Explore a new all-original story, \"Key to the Unknown,\" set after the events of this arc and the original series. Plus, get to know new sides of your favorite characters in “Character Stories,” as well as tons of new interactions and moments that can only be seen in the game!",
        sku: "812345678901208",
        url: "https://gameone.ph/pre-order-playstation-ps5-fairy-tail-2-r3.html",
        categories: [
            "PlayStation",
            "PS5 Games"
        ]
    ...
    {
        title: "Skull & Co. X Savage Raven AudioDrive Bluetooth 5.2 Audio Adapter for PS4/PS5/SWITCH/PC and Other Devices",
        price: 650,
        availability: true,
        image: "https://gameone.ph/media/catalog/product/cache/d378a0f20f83637cdb1392af8dc032a2/s/k/skull_co_savage_raven_audio_drive_ad01-bk_-9.jpg",
        description: "Compatible With: PS4, PS5, Switch, PC, TV and more.\nUSB-A Port, Driver Free\nHigh fidelity low latency codecs - ensures audio sync, enhances gaming performance.\nWorks with all Bluetooth headphones - optimized for AirPods and AirPods Pro.\nStable performance - Uninterrupted play with your favorite wireless headphones.\nShare the fun - connect two headphones simultaneously.\nLouder and clearer - provides a better sound experience than SWITCH's built-in Bluetooth audio.",
        sku: "41234566812586",
        url: "https://gameone.ph/skull-co-x-savage-raven-audiodrive-bluetooth-5-2-audio-adapter-for-ps4-ps5-switch-pc-and-other-devices.html",
        categories: [
            "PlayStation",
            "Accessories"
        ]
    ...
    {
        title: "Sony PlayStation VR2 PC Adaptor (CFI-ZVP1)",
        price: 3290,
        availability: false,
        image: "https://gameone.ph/media/catalog/product/cache/d378a0f20f83637cdb1392af8dc032a2/s/o/sony_playstation_vr2_pc_adaptor_cfi-zvp1_.jpg",
        description: "Expand the library of games to play on your PlayStation VR2.\nBrowse, buy and play thousands of virtual reality games on Steam™. Discover multiplayer open worlds, survival horrors and stealth action games, plus sports sims, quirky puzzlers and free-to-play epics—explore Steam's huge range of virtual reality games to expand your PlayStation VR2 experience.\nConnect the PlayStation VR2 PC adapter to your PlayStation VR2 and a Windows PC, download the SteamVR App and the free PlayStation VR2 App from Steam, and find your next favourite virtual reality game.\nFeatures:\nAccess to SteamVR  - Thousands of virtual reality games on Steam available to buy and play.\nConvenient connectivity - Connects PlayStation VR2 to a PC.2\nGet the app - Download the free PlayStation VR2 App from Steam to connect the PlayStation VR2 headset to a PC.",
        sku: "4948872416344",
        url: "https://gameone.ph/sony-playstation-vr2-pc-adaptor-cfi-zvp1.html",
        categories: [
            "PlayStation",
            "Accessories"
        ]
    ...
    {
        title: "KontrolFreek Action-Adventure Thumbsticks CQC Edition for PS4 | PS5 (7150-PS5)",
        price: 775,
        availability: true,
        image: "https://gameone.ph/media/catalog/product/cache/d378a0f20f83637cdb1392af8dc032a2/s/t/steelseries_kontrol_freek_cqc_ed._7150-ps5_.png",
        description: "KontrolFreek Performance Thumbsticks for Action-Adventure games are designed to upgrade your aim, grip, and control during your most intense and exciting adventures. CQC Edition Thumbsticks are ideal for anyone looking to improve their performance in close quarter combat or from a distance. \nFrom the Experts:\n-Dramatically upgrade your aim, grip and control in action-adventure games   \n-Mid-rise thumbstick improves grip and control on left analog  \n-Mid-rise thumbstick increases accuracy of attacks on right analog \n-New improved proprietary rubber material for extra grip and comfort \n-Made in the USA by the industry leading controller enhancement brand",
        sku: "810052985527",
        url: "https://gameone.ph/kontrolfreek-action-adventure-thumbsticks-cqc-edition-for-ps4-ps5-7150-ps5.html",
        categories: [
            "PlayStation",
            "Accessories"
        ]
    ...
    {
        start: "here",
        title: "OTVO Multifunctional Cooling Stand for PS5 | PS5 Slim (IV-P5246X)",
        price: 1095,
        availability: true,
        image: "https://gameone.ph/media/catalog/product/cache/d378a0f20f83637cdb1392af8dc032a2/o/t/otvo_ps5_multifunctional_cooling_stand_iv-p5246x_.png",
        description: "Features:\n- Storage\n- Charging\n- Cooling\n- With 4 Charging Adapter Terminal\n- Metal Base\n- Compatible with PS5 | PS5 Slim\nNote: PS5 Console, Controller, Headset, and Game Disc NOT included",
        sku: "6972861540572",
        url: "https://gameone.ph/otvo-multifunctional-cooling-stand-for-ps5-ps5-slim-iv-p5246x.html",
        categories: [
            "PlayStation",
            "Accessories"
        ]
    ...
    {
        title: "Dobe Multifunctional Cooling & Charging Stand for PS5 | PS5 Slim - Black (TP5-0593S)",
        price: 895,
        availability: true,
        image: "https://gameone.ph/media/catalog/product/cache/d378a0f20f83637cdb1392af8dc032a2/d/o/dobe_ps5_multifunctional_cooling_charging_stand_tp5-0593s_-1.jpg",
        description: "Features:\n- 3 Speed Levels\n- Dual Charging\n- Can store 11 Game Disc\n- Compatible for PS5 | PS5 Slim\nNote: PS5 Console, Controller & Headset are NOT included",
        sku: "6972520257346",
        url: "https://gameone.ph/dobe-multifunctional-cooling-charging-stand-for-ps5-ps5-slim-black.html",
        categories: [
            "PlayStation",
            "Accessories"
        ]
    ...
    {
        title: "Kytok Multiple Controller & Headset Desk Stand (KT-K516)",
        price: 795,
        availability: true,
        image: "https://gameone.ph/media/catalog/product/cache/d378a0f20f83637cdb1392af8dc032a2/k/y/kytck_multiple_controller_desk_stand_kt-k516_.jpg",
        description: "Upgraded Headset and Controller Holder for Desk\nKytok made a new upgrade gaming controller stand - stores 6 controllers or 2 headsets + 2 controllers for PlayStation PS5/PS4/PS3/PS2, Xbox One, Series X/S/Elite, Nintendo Switch Pro controller. 2 storage methods are available in this headphone and controller stand.\nStable & Durable Material Accessories\nThere are entire accessories in aluminum alloy material instead of a mix of plastic in this Xbox controller holder. And you will feel the weight when you pick up accessories of this Switch controller holder. Especially the sturdy bottom base brings the stability to the support of the whole PS4 controller holder and the assembled headset holder stand does not fall off easily.\nSuper Easy Assembly\nThe installation steps are very simple in this Nintendo Switch controller holder. Firstly use 2 screws to pass up through the bottom base, then place and tighten 2 lower rods, then place the curved board in turn, and install the 3 curved boards layer by layer. The thoughtful included screwdriver makes your PS5 headset holder installation more effortless.\nSave Space & Keep Desk Neat\n The controller organizer for desk takes 18 x 37CM, high but stable and only takes up a little your space to store your gaming controllers and headphones of Xbox PS4 PS5 Nintendo Switch. Multiple controller desk stand makes your gaming area clean and organized.\nKytok Controller Holder Stand - What You Get\n1 x bottom plate, 1 x screwdriver, 2 x rod, 3 x flat screw, 3 x curved screw, 3 x controller holder, 4 x rod with external thread.",
        sku: "6972861545164",
        url: "https://gameone.ph/kytok-multiple-controller-headset-desk-stand-kt-k516.html",
        categories: [
            "PlayStation",
            "Accessories"
        ]
    ...
    {
        title: "Dobe Cooling Fan for New PS5 Slim Console (TP5-3538) - Transparent Black",
        price: 350,
        availability: true,
        image: "https://gameone.ph/media/catalog/product/cache/d378a0f20f83637cdb1392af8dc032a2/d/o/dobe_ps5_cooling_fan_transparent_black_tp5-3538_.jpg",
        description: "Keep your PS5 Slim Console cool with the Dobe Cooling Fan (TP5-3538)! Designed for efficient heat dissipation, this cooling fan ensures optimal performance during intense gaming sessions.\nTechnical Specifications\nOperating Voltage: DC 5V\nOperating Current: 0.5A\nFan Speeds: High, Medium, Low\nNumber of Fans: 3\nProduct Dimensions: 290*69*35mm (Length*Width*Height)\nProduct Material: ABS\n \nNote: PS5 Console Machine not included",
        sku: "6972520256653",
        url: "https://gameone.ph/dobe-cooling-fan-for-new-ps5-slim-console-tp5-3538-transparent-black.html",
        categories: [
            "PlayStation",
            "Accessories"
        ]
    ...
    {
        title: "Dobe Charging Station for PS5 | Edge Controller (TP5-1501S)",
        price: 595,
        availability: true,
        image: "https://gameone.ph/media/catalog/product/cache/d378a0f20f83637cdb1392af8dc032a2/d/o/dobe_ps5_charging_station_tp5-1501s_.jpg",
        description: "Keep your PS5 and Edge controllers powered up with the Dobe Charging Station for PS5/Edge Controller (TP5-1501S).\nFeaturing two charging slots and a fast charging capability, this station ensures your controllers are always ready for action. The charging indicator lets you know the status of your controllers at a glance. Ensure uninterrupted gaming sessions with this efficient charging solution.\nCompatible for PS5 & PS5 Edge Controller\n \nNote: Controller not included",
        sku: "6972520256318",
        url: "https://gameone.ph/dobe-charging-station-for-ps5-edge-controller-tp5-1501s.html",
        categories: [
            "PlayStation",
            "Accessories"
        ]
    ...
    {
        title: "Dobe Silicone Case for PS5 Controller (TP5-05112)",
        price: 150,
        availability: true,
        image: "https://gameone.ph/media/catalog/product/cache/d378a0f20f83637cdb1392af8dc032a2/d/o/dobe-ps5-silicone-case-2.jpg",
        description: "Protects your or your PlayStation 5 controller from dust, scratches, damage, and daily usage.A variety of styles and colors to choose from.The surface of this cover is designed with 3D Studded Edition.It is non-slip and also increases the experience of the game.Durable silicone sleeve is easy to install and remove, and will not interfere with the function of the controller after it is put on, will not hinder the use of any buttons and ports.\nNote: Controller not included",
        sku: "812345678900964",
        url: "https://gameone.ph/dobe-silicone-case-for-ps5-controller-tp5-05112.html",
        categories: [
            "PlayStation",
            "Accessories"
        ]
    ...
    {
        title: "PlayStation Pulse 3D Wireless Headset with DualSense Wireless Controller Gray Camouflage Bundle",
        price: 9595,
        availability: true,
        image: "https://gameone.ph/media/catalog/product/cache/d378a0f20f83637cdb1392af8dc032a2/p/u/pulse_3d_headset_ds5_controller_bundle_-_1.jpg",
        description: "Restyle your PS5™ gaming setup in a fresh urban aesthetic with Grey Camouflage accessories. \nBuilt for A New Generation\nFine-tuned for 3D audio on PS5™ consoles.*Enjoy comfortable gaming with refined earpads and headband strap.Play in style with a sleek design that complements the DualSense™ controller.Designed for Gamers \nChat with your friends through the hidden noise-cancelling microphones.**Quickly adjust audio and chat settings with easy-access controls.Take Your Adventures Further \nEnjoy up to 12 hours of wireless play with the built-in rechargeable battery.Easily connect to your PS5™ or PS4™ console using the wireless adaptor.Connect to PlayStation®VR and mobile devices with the included audio cable.****Available when feature is supported by game.\n**Internet and account for PlayStation™Network required.\n***Built-in headset controls not supported on PS VR and mobile devices.Discover a deeper, highly immersive gaming experience* that brings the action to life in the palms of your hands. The DualSense wireless controller offers immersive haptic feedback**, dynamic adaptive triggers** and a built-in microphone, all integrated into an iconic comfortable design. *Compared to DUALSHOCK 4 wireless controller. **Available when feature is supported by game.\nBring gaming worlds to life\n- Haptic feedback\n- Adaptive triggers\n- Built-in microphone and headset jack \n- Create button\n- A gaming icon in your hands\n- Familiar features \n- Click. Charge. Play.",
        sku: "812345678900931",
        url: "https://gameone.ph/playstation-pulse-3d-wireless-headset-with-dualsense-wireless-controller-gray-camouflage-bundle.html",
        categories: [
            "PlayStation",
            "Accessories"
        ]
    ...
    {
        title: "Final Fantasy VII Anniversary Art Museum Digital Card Plus VOL.2 Box (20 Packs)",
        price: 3980,
        availability: true,
        image: "https://gameone.ph/media/catalog/product/cache/d378a0f20f83637cdb1392af8dc032a2/f/i/final-fantasy-vii-anniversary-art-museum-digital-card-plus-vol.2-1.jpg",
        description: "Second series of physical trading cards featuring over 200 artworks across FINAL FANTASY VII universe, from the original FINAL FANTASY VII to the latest installment FINAL FANTASY VII REBIRTH. Cards can be collected both physically and digitally, allowing fans to enjoy their collection anywhere, anytime.\nThis is a sealed physical display box that contains 20 physical card packs.  Each card pack contains 6 physical trading cards randomly selected from all 209 design variations, along with 1 exchange ticket that can be redeemed for any one digital card of choice!\nTotal 209 design variations to collect, both as physical trading cards and digital cards.\n\n99 x Normal Cards\n99 x Premium foil cards\n3 x Variant normal cards\n3 x Variant premium foil cards\n3 x Secret Cards\n3 x Super Secret Cards\n\nThis trading card set is a great way to collect your favorite cards filled with the charm of FINAL FANTASY VII.",
        sku: "4988601376495",
        url: "https://gameone.ph/final-fantasy-vii-anniversary-art-museum-digital-card-plus-vol-2-20-packs.html",
        categories: [
            "PlayStation",
            "Others"
        ]
    ...
    {
        title: "Hori Fighting Stick Alpha Street Fighter 6 Edition for PS5 / PS4 / PC",
        price: 14575,
        availability: true,
        image: "https://gameone.ph/media/catalog/product/cache/d378a0f20f83637cdb1392af8dc032a2/h/o/hori_streetfighter_6_arcade_stick_spf-033a_.jpg",
        description: "High-end tournament ready fight stick, compatible with PlayStation 5, PlayStation 4, and PCOpens for easy customization & maintenanceIncludes link to 18 downloadable hi-res images of your favorite Street Fighter 6 characters for top-panel customizationFeatures HORI’s proprietary HAYABUSA buttons and HAYABUSA joystickOfficially Licensed by Sony and Capcom\nCompatible models: PlayStation®️5, PlayStation®️4, PC ^1Required system: USB port, Internet connection environment ^2Supported OS: Windows®️ 10/11\nNote:\nThis product is only compatible with XInput compatible games. It does not support games that support DirectInput.\nAn internet connection environment is required to update the version of PlayStation®️5 and PlayStation®️4.",
        sku: "6975977470023",
        url: "https://gameone.ph/hori-fighting-stick-alpha-street-fighter-6-edition-for-ps5-ps4-pc.html",
        categories: [
            "PlayStation",
            "Others"
        ]
    ...
    {
        title: "Paladone Playstation Logo Light - PP10240PS",
        price: 1995,
        availability: true,
        image: "https://gameone.ph/media/catalog/product/cache/d378a0f20f83637cdb1392af8dc032a2/p/l/playstation_logo_light.jpg",
        description: "PLAYSTATION LIGHT- Decorate your game room, man cave, or bedroom with the PlayStation Logo Light which features the iconic Playstation logo. It is both free-standing and wall-mountable\nTHREE LIGHTS MODES- This 21 cm (8”) tall light features a stand along with the light modes color phasing, color select, and music reactive. Powered by battery or USB (3 x AA and micro USB not included)\nICONIC BRAND - PlayStation is one of the top gaming brands in the world with its logo, video games, icons, console, controller, and name being instantly recognizable to gamers of all ages\nFUN GIFTS FOR FUN PEOPLE- For those looking for cool stuff and all things geek, crazy, and unique, we are proud to create top-selling toys, mugs, lights, decor, and presents that make people smile\nOFFICIALLY LICENSED MERCHANDISE- Discover a new piece of merch for your collection with our array of collectibles for men, women, fans, kids, boys, and girls who love pop culture fun",
        sku: "5055964794699",
        url: "https://gameone.ph/paladone-playstation-logo-light-pp10240ps.html",
        categories: [
            "PlayStation",
            "Others"
        ]
    ...
    {
        title: "Paladone Playstation Icons Light PS5 XL - PP7917PS",
        price: 2095,
        availability: true,
    ...
    {
        title: "Paladone 8-Bit Pixel Game Over Light [PP5016V3]",
        price: 1995,
        availability: true,
        image: "https://gameone.ph/media/catalog/product/cache/d378a0f20f83637cdb1392af8dc032a2/p/a/paladone-game-over-1.jpg",
        description: "GAME OVER: Fans of vintage video games will love this light! Featuring the words “game over,” this light recalls back to gaming in the past. Fellow video gamers will love seeing this light!\nDETAILS: This homage to the 8 - bit gaming era stands 30 centimeters wide (approximately 12 inches) and is sound reactive and color phasing. It features the colors orange, blue, green, and purple.\nLIGHT THE NIGHT: Use this nightlight as a desk lamp on the nightstand by your bed. It’s a perfect way to illuminate your man cave, bedroom, baby nursery, toddler’s playroom, or themed home theater.\nNOVEL AND ORIGINAL: For those in the fandom looking for novelty items and all things geek, crazy, and unique, Paladone is your best source for top-selling toys, mugs, collectibles, and novelties.\nOFFICIALLY LICENSED: This quality collectible is a unique addition to any fan's set. Give this cool collector's merchandise to moms, dads, fans, teens, kids, boys, and girls who love pop culture fun!",
        sku: "4123456772550",
        url: "https://gameone.ph/paladone-8-bit-pixel-game-over-light.html",
        categories: [
            "PlayStation",
            "Others"
        ]
    ...
    {
        title: "Paladone PlayStation Icons Light V2 - PP4140PSV2",
        price: 1995,
        availability: true,
        image: "https://gameone.ph/media/catalog/product/cache/d378a0f20f83637cdb1392af8dc032a2/p/a/paladone-icon-lights.jpg",
        description: "Perfect for gamers, this PlayStation Icons Light features the classic PlayStation controller button symbols on a sleek black plinth, making an ideal addition to any bedroom or gaming den.\n\nFeaturing three different settings, including standard lighting, colour phasing and music reactive modes, the PlayStation Icons Light is the perfect accompaniment to your gaming.The first gaming console to ever ship 100 million units, the original PlayStation was launched by Japan based electronics company Sony in 1994, rapidly becoming one of the best known gaming brands in the world. With successive consoles building on that original unprecedented success (including the best-selling console of all time, the PlayStation 2), the iconic image, name and logos of the Sony brand are instantly recognizable with gamers of all ages. The PlayStation controller, with its distinctive shape and iconic button symbols of a green triangle, blue x, red circle and pink square, are now virtually synonymous with console gaming in general.A great gift for gamers of all ages, the PlayStation Icons Light is an officially licensed product. Batteries not included.This product is made using BDP™ which stands for Breakdown Plastic – an organic additive that helps plastic decompose at landfill without affecting either its structural integrity (before landfill) or the recyclability of the product.",
        sku: "5055964715151",
        url: "https://gameone.ph/paladone-playstation-icons-light-v2.html",
        categories: [
            "PlayStation",
            "Others"
        ]
    ...
    {
        title: "DualShock4 Wireless Controller Cushion [Silver] Small",
        price: 1650,
        availability: true,
        image: "https://gameone.ph/media/catalog/product/cache/d378a0f20f83637cdb1392af8dc032a2/p/l/playstation-dualshock-steel-silver-small.jpg",
        description: "Official Licensed Product\nMaterial: 100% Polyester\nSize: approx. \nMade in Taiwan\nPillowcase is not removable.\nActual product may differ from photos.",
        sku: "4123456723142",
        url: "https://gameone.ph/dualshock4-wireless-controller-cushion-silver-small.html",
        categories: [
            "PlayStation",
            "Others"
        ]
